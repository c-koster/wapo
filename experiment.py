...
#   I DO have natural labels, and as i suspected the labels look like this:
...
from collect import search_with_terms, get_by_id


def extract_features(id1: str, id2: str) -> Any:
    """
